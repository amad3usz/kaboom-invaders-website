			...
			<div className="row row-content">
				...
				<div className="col align-self-center">
					...
					<p className="text-start">
						...
						use the arrow keys. Not only can you move left and right, you can also move up and down, which might definitely prove to be helpful, especially if you want to beat your
						previous high score. To shoot your laser, you just tap the spacebar. That's basically it for controls.
					</p>
				</div>
			</div>
			<div className="row row-content">
				<div className="col align-self-center">
					<p className="text-start">
						Now in order to win the game, you must shoot down all the Kaboom Babies before the timer runs out or before one collides with your rocket. These Kaboom Babies are particularly
			...
			<div className="row row-content">
				...
				<div className="col align-self-center">
					...
					<p className="text-start">
						...
						with new things. Having worked previously as a 3rd grade teacher and a freelance violinist (along with a number of odd jobs), I have built up quite a unique skillset that has
					...
					<p className="text-start">
						This project definitely took me out of my comfort zone. Having mostly worked mostly with React and a few other JS libraries, exploring this new library was actually really fun!
						KaboomJS is a relatively new JavaScript library that is built for creating games quickly. I heard about it for the first time at the beginning of a Mintbean hackathon, so there
						was tons to learn in less than a week. I think the project was a success and has definitely sparked an interest in me for developing games. It has also reignited an old
						interest in pixel art, which was all done by me for this game. I really hope you enjoy playing it. Try beating my high score of 3750!
					</p>
				</div>
			</div>
		</div>
